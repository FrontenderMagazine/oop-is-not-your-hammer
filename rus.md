...
В нашем примере с интернет-магазином, контроллер может публиковать события, вроде “cart.add-item”, которые вместе с данными заказанного товара. Другой компонент -  контроллер корзины, например, может подписываться на событие “cart.add-item” и использовать его для управления корзиной на странице.
...
[2]: http://todomvc.com/
[3]: http://ru.wikipedia.org/wiki/Аспектно-ориентированное программирование
